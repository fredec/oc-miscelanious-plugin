<?php
    ...
    class UploadForm extends MagicForm {
        ...
        public function onRun() {
            parent::onRun();
            $this->addCss(url('plugins/martin/forms/assets/css/uploader.css'));
            $this->addJs(url('plugins/martin/forms/assets/vendor/dropzone/dropzone.js'));
            $this->addJs(url('plugins/martin/forms/assets/js/uploader.js'));
