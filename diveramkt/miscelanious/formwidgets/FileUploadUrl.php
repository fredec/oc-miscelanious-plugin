<?php namespace Diveramkt\Miscelanious\FormWidgets;
 ...
 */
class FileUploadUrl extends FormWidgetBase
{
    ...
    public function getConfigFormWidget()
    {
        ...
        $config = $this->makeConfig('~/plugins/diveramkt/miscelanious/formwidgets/fileuploadurl/file/fields.yaml');
            ...
            if ($file = $formWidget->model) {
                ...
                Db::transaction(function () use ($modelsToSave, $formWidget) {
                    foreach ($modelsToSave as $modelToSave) {
                        ...
                        // if(isset($modelToSave['video'])){
                        //     $arquivo = "meu_arquivo.txt";
                        //     $fp = fopen($arquivo, "a+");
                        //     fwrite($fp, json_encode($modelToSave['video']));
                        //     fclose($fp);
                        //     unset($modelToSave['video']);
                        // }
